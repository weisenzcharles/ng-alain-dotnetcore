package com.weisenz.weiadmin.config.datasource;
...
@Configuration
@MapperScan(basePackages = "com.weisenz.weiadmin.mapper.product", sqlSessionFactoryRef = "productSqlSessionFactory")
